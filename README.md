...
- [0010: parijona 向け AccountingAI を fork で独立進化させる](./docs/adr/0010-fork-for-parijona-accounting-ai.md) — parijona 向け開発は fork 先リポ `AI-LandBase/parijona_accounting_ai` で行う
